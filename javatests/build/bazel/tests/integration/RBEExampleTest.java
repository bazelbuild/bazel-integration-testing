...
public class RBEExampleTest extends BazelBaseTestCase {
  ...
  private static List<String> remoteCompatibleToolchainFlags() {
    return Arrays.asList(
        "build --crosstool_top=@bazel_toolchains//configs/ubuntu16_04_clang/1.2/bazel_0.23.0/default:toolchain",
        "build --extra_toolchains=@bazel_toolchains//configs/ubuntu16_04_clang/1.2/bazel_0.23.0/cpp:cc-toolchain-clang-x86_64-default",
